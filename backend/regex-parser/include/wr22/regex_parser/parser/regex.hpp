...
/// parsed and its object representation (see the docs for `regex::SpannedPart`) is built. The
/// returned representation is an owned object and its lifetime does not depend on the lifetime of
/// the `regex` argument.
///
